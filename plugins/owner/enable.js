  ...
  switch (type) {
      ...
      if (!m.isGroup) {
        if (!isOwner) {
          return await conn.reply(
            m.chat,
            "Only owner can use this command in private chat!",
            m,
          );
        }
      } else if (!isAdmin) {
        return await conn.reply(
          m.chat,
          "Only admin can use this command in group chat!",
          m,
        );
      }
    ...
    case "antiviewonce":
      if (m.isGroup) {
        if (!(isAdmin || isOwner)) {
          return await conn.reply(
            m.chat,
            "Only admin or owner can use this command in group chat!",
            m,
          );
        }
      }
    ...
    case "self":
      ...
      if (!isROwner) {
        return await conn.reply(
          m.chat,
          "Only regular owner can use this command!",
          m,
        );
      }
