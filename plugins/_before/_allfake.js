...
handler.all = async function (m) {
  ...
  try {
    ...
    global.pic = "https://telegra.ph/file/02f8f1df8faf9df0fda6c.jpg";
    ...
    global.adReply = {
      contextInfo: {
        ...
        externalAdReply: {
          ...
          previewType: "PHOTO",
          thumbnail: await (
            await fetch("https://telegra.ph/file/02f8f1df8faf9df0fda6c.jpg")
          ).buffer(),
          sourceUrl: "",
        },
      },
    ...
    global.ftoko = {
      key: {
        fromMe: false,
        participant: `0@s.whatsapp.net`,
        ...(m.chat ? { remoteJid: "17608914335@s.whatsapp.net" } : {}),
      },
      message: {
        productMessage: {
          product: {
